package com.cw2.nekoama.core.logging
...
object NekoamaLogger {
    ...
    class BatchLogger(private val operation: String) {
        ...
        fun debug(message: String) {
            NekoamaLogger.debug(operation, message, context)
        }
        
        fun info(message: String) {
            NekoamaLogger.info(operation, message, context)
        }
        
        fun warn(message: String, error: Throwable? = null) {
            NekoamaLogger.warn(operation, message, context, error)
        }
        
        fun error(message: String, error: Throwable? = null) {
            NekoamaLogger.error(operation, message, context, error)
        }
        
        fun logError(nekoamaError: NekoamaError) {
            NekoamaLogger.logError(operation, nekoamaError, context)
        }
