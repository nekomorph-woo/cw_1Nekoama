...
data class ProxyConfig(
    ...
    fun toJavaProxy(): Proxy {
        return when (type) {
            ...
            ProxyType.HTTP -> Proxy(Proxy.Type.HTTP, java.net.InetSocketAddress.createUnresolved(host!!, port!!))
            ProxyType.HTTPS -> Proxy(Proxy.Type.HTTP, java.net.InetSocketAddress.createUnresolved(host!!, port!!))
            ProxyType.SOCKS -> Proxy(Proxy.Type.SOCKS, java.net.InetSocketAddress.createUnresolved(host!!, port!!))
        }
    }
