package com.cw2.nekoama.domain.settings.service
...
object NekoamaSecureStorage {
    ...
    suspend fun getApiKey(): String {
        return withContext(Dispatchers.IO) {
            ...
            runCatching {
                ...
                val creds = PasswordSafe.Companion.instance.get(attrs)
    ...
    fun setApiKey(value: String) {
        try {
            val attrs = credentialAttributes()
            if (value.isBlank()) {
                PasswordSafe.Companion.instance.set(attrs, null)
            } else {
                PasswordSafe.Companion.instance.set(attrs, Credentials(null, value))
            }
        } catch (_: Throwable) {
