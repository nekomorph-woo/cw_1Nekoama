...
import com.cw2.nekoama.interfaces.intellij.tool_window.extension.TabExtension
import com.cw2.nekoama.interfaces.intellij.tool_window.extension.TabExtensionAdapter
import com.cw2.nekoama.interfaces.intellij.tool_window.extension.TabExtensionConfigManager
import com.cw2.nekoama.interfaces.intellij.tool_window.extension.TabExtensionPoint
import com.cw2.nekoama.interfaces.intellij.tool_window.extension.TabExtensionPointSingleton
...
class NekoamaTabManager private constructor() {
    ...
    fun registerTab(tab: NekoamaTab) {
        ...
        if (tab is MetricsUpdateListener) {
            MetricsCollector.addListener(tab)
        }
    ...
    fun unregisterTab(tabId: String) {
        ...
        // 从指标采集器移除监听器
        if (tab is MetricsUpdateListener) {
            MetricsCollector.removeListener(tab)
        }
